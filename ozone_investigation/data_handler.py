...
def height_year(data, year, min_bool):
    """calculates and plots the height of
    max. mean concentration for a certain year"""
...
def height_mean(data, min_bool):
    """calculates and plots the height of max. mean concentration
...
def height_mean_seasons(data, min_bool):
    """calculates and plots the height of max. mean concentration
    for a season-wise for the whole time frame"""
...
def vertical_concentrations(data):
    """calculates and plots mean concentration for
    vertical profiles of global-, tropical-, high- and mid-latitudes"""
...
def seasonal_concentrations(data, season):
    """calculates and plots time series of the concentration
    above the northern polar circle, season-wise"""
